...
// -> @Order 에너테이션을 사용해서 테스트 메서드의 실행 순서를 지정.
public class PostRepositoryTest {
    ...
    public void testSave() {
        // JpaRepository의 sava() 메서드 :
        //   1. 엔터티가 테이블에 없는 경우, insert
        //   2. 엔터티가 테이블에 있는 경우(테이블에서 검색한 경우), update
        
        Post entity = Post.builder().title("Spring JPA").content("Java Persistence API").author("admin").build();
    ...
    public void testFindAll() {
        ...
        // 데이터베이스 테이블에서 전체 검색: select * from POSTS;
