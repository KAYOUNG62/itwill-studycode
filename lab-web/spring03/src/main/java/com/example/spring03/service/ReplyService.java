...
public class ReplyService {
    ...
    public Integer create(ReplyRegisterDto dto) {
        ...
        // DTO를 Reply Entity로 변환
        Reply reply = Reply.builder().post(post).replyText(dto.getReplyText()).writer(dto.getWriter()).build();
    ...
    // 데이터베이스 테이블에서 포스트 번호에 달려잇는 모든 댓글을 검색해서 리스트를 리턴
    ...
    public List<ReplyReadDto> readReplies(Integer postId) {
        ...
        // List<Reply> 를 List<ReplyReadDto>로 변화해서 리턴
