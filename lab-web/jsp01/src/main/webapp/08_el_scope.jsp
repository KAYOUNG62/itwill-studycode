...
<body>
    ...
    pageContext 속성:
    <%=pageContext.getAttribute("number1")%>
    <br /> request 속성:
    <%=request.getAttribute("number2")%>
    <br /> session 속성:
    <%=session.getAttribute("number3")%>
    <br /> application 속성:
    <%=application.getAttribute("number4")%>

    <h2>EL</h2>
    pageScope 속성: ${ pageScope.number1 }
    <br /> requestScope 속성: ${ requestScope.number2 }
    <br /> sessionScope 속성: ${ sessionScope.number3 }
    <br /> applicationScope속성 : ${ applicationScope.number4 }
