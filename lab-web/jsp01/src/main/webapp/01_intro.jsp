...
<body>
    ...
    <%-- declaration(선언문) --%>
    <%!
    private final String username = "admin"; // 클래스의 필드(멤버변수) 
    ...
    <%-- JSP 주석 --%>
    <%-- Servlet/JSP 동작 방식
    Servlet : Server + Applet 합성어. (웹서버에서 실행되는, 요청을 처리하는 작은 프로그램)  
        - 웹 서버가 클라이언트로부터 요청을 받았을 때 동적으로 HTML 문서를 생성하기 위한 기술
        - Java class로 작성
        - Servlet 생성과 Servlet 객체의 메서드 호출은 WAS가 담당.
    ...
    JSP : Java Server Page
        ...
        - JSP의 동작 원리: jsp -> java -> class -> 객체생성 -> 메서드 호출.
