...
@TestMethodOrder(OrderAnnotation.class) // 테스트 메서드들의 실행 순서를 에너테이션으로 지정.
public class PostDaoTest {
    ...
    public void testinsert() {
        //DB 테이블에 insert할 데이터(제목, 내용, 작성자)
        Post entity = Post.builder().title("DAO test").content("테스트").author("admin").build();
