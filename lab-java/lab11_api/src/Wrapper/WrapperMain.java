...
// Wratter 클래스들을 java.lang 패키지에 포함되어있음 > import 문장 없이 사용 가능.
// Wrapper 클래스를 사용하는 목적:
// 1.기본 타입 데이터들을 이용하는 메서드 제공
// 2.상속/다형성을 사용하기 위해서.
...
public class WrapperMain {
    ...
    public static void main(String[] args) {
        ...
        int x = Integer.parseInt("123"); // String -> int (기본타입)
        ...
        int add = number1 + number2; // auto- unboxing : Integer 타입의 객체를 int 타입으로 자동 변환
        System.out.println(add);

        // float, double 타입은 소수점 이하 오차가 생길수 있음.
        double d1 = 1.1;
        double d2 = 0.9;
        System.out.println(d1 - d2);

        // Double 타입의 오차를 원하는 수준까지 작게 줄일 수 있는 클래스- BigDecimal
        BigDecimal big1 = new BigDecimal("1.1"); // 생성자 호출 > 객체생성
        BigDecimal big2 = new BigDecimal("0.9");
        System.out.println("big1= " + big1);
        System.out.println("big2= " + big2);
        System.out.println(big1.subtract(big2)); // 메서드 호출 > 산술연산(+ - * /) 
