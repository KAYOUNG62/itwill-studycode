...
public interface MemberDao {
    /**
     * 신규회원정보등록. argument로 저장된 Member 객체를 배열에 저장.
     * 
     * @param m 신규등록할 회원 정보
     * @return 배열에 새로운 회원 저장이 성공하면 1, 그렇지 않으면 0을 리턴.
     */
    int create(Member m); // public abstract

    /**
     * 전체 회원 목록 검색 기능. 모든 회원정보가 저장된 배열을 리턴.
     * 
     * @return 회원정보가 저장된 배열.
     */
    Member[] read();
    ...
    /**
     * 인덱스를 사용한 회원정보 검색 기능. 배열에서 해당 인덱스의 Member 객체를 찾아서 리턴
     * 
     ...
     * @return 비밀번호 수정 성공하면 1, 그렇지않으면 0을 리턴.
     */
