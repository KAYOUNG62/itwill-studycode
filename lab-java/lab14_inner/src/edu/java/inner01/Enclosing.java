...
public class Enclosing {
    ...
    private int instanceVriable; // 인스턴스 멤버

    // constructor
    public Enclosing(int instanceVriale) {
        this.instanceVriable = instanceVriale;
    }
    ...
    public void instanceMethod() {
        ...
        System.out.println("Instance Var = " + instanceVriable);
    }

    // static inner class(nested class)
    // - 외부 클래스의 객체 생성 여부와 상관 없이, 생성자를 호출하고 사용할 수 있는 클래스.
