...
// import static 문장: static 필드, 메서드, 클래스 이름을 import 할 때 사용. 
import static edu.java.interface01.DatabaseModule.DB_VERSION;

// 인터페이스(interface) 
// 사용 목적: 팀/회사 간의 분업/협업을 하기 위해 메서드(기능)들의 프로토타입(prototype, signature)를 약속하기위한 규약.
// 인터페이스가 가질 수 있는 멤버들:
// 1) public static final 필드(멤버변수) "public final static"은 보통 생략함. 
// 2) public abstract 메서드. "public abstract" 는 보통 생략함.
// 인터페이스를 선언할 때 : interface 키워드 사용. 
// 인터페이스는 객체를 생성할 수 없고, 인터페이스를 "구현"하는 클래스.
// - 구현클래스 : class 클래스이름 implement 인터페이스 이름{...}
...
public class InterfaceMain01 {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(DatabaseModule.DB_VERSION); / import 문장이 없을 경우 클래스 이름도 작성해야됨
        // DatabaseModule.DB_VERSION = 2; / final이기 때문에 변경 불가능.
