...
public class FileMain03 {
    ...
    public static void main(String[] args) {
        ...
        //read(byte[] b), write(byte[] b, int off, int len)를 사용했을때 
        //복사시간의 차이 비교
        ...
        try {
            ...
            out = new FileOutputStream("data/ratings_copt.dat");
            ...
            System.out.println("read()> 파일복사종료 - " + elapsedTime + "ms");
        ...
        try { 
            ...
            System.out.println("read(byte[] b)> 파일복사종료 - " + elapsedTime2 + "ms");
