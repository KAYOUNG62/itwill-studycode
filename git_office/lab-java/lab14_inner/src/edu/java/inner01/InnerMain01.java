 ...
 *    (1) 인스턴스변수 :static이 아닌 필드.
 *      - 객체 생성후에 그 참조변수를 이용해야 사용할 수 있는 필드. (예시 InnerMain app = new InnerMain(); > 에서 app)
 ...
 *    - 파라미터도 지역 변수의 한 종류.
 *    - 지역 변수는 static 으로 선언할 수 없음!
 *    
 * 내부 클래스(inner class/interface): 다른 클래스/인터페이스의 내부에서 선언하는 클래스/인터페이스.
 ...
 *    (2) static 내부 클래스 - 중첩클래스. (nested class)
...
public class InnerMain01 {
    ...
    public static void main(String[] args) {
        ...
        InnerMain01 app = new InnerMain01(); // 객체생성
