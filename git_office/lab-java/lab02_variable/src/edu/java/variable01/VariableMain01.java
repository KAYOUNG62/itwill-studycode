...
public class VariableMain01 {
	...
	public static void main(String[] args) {
		...
		int salary = 100; //변수 선언과 초기화를 한문장에서 작성.
		...
		//2. 변수이름은 숫자로 시작할 수 없음. ex int 1n; <불가능
		//3. 변수이름은 소문자로 시작하는것이 좋음.
		//4. 변수이름이 2개 이상의 단어로 이루어질때는 camel 표기법을 사용하는것을 권장 ex int phoneNumber; 
