...
public class User {
    ...
    public String toString() {
        // String user = String.format("User(Id=%s , passsword=%s)", this.userId,
        // this.password);
        return "User(userId=" + this.userId + ", password=" + this.password + ")";
    }

    // equals() 재정의: 아이디가 위치하는 User 객체는 같은 객체.
    @Override
    public boolean equals(Object obj) {
        ...
        if (obj instanceof User) {
            ...
            // 주의! String 타입 2개를 비교하므로 == 연산자가 아닌 equals를 사용
        }
        return result;
    }
